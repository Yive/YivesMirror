...
Amber::Server.configure do |settings|
  ...
  #
  # settings.name = "Yives Mirror web application."
  #
  #
  ...
  #
  # settings.secret_key_base= 5n7SGh2uejlnUSO_1fBjOuh97x3CROZANoYo-FHHzBs
  #
  #
  ...
  #
  # settings.logger = Amber::Environment::Logger.new(File.open("yives_mirror.log", "w"))
  #
  #
end
